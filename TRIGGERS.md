# Trigger Guide — shared-agentic workflows

How each agentic workflow in this repository starts, what it needs, what it
...
3. **Vendor** — projects never dispatch into this repo.
